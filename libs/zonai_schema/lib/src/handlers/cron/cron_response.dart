...
final class CleanupUnreferencedPhotosResponse extends CronResponse {
  CleanupUnreferencedPhotosResponse({
    required super.id,
  ...
  static const _path = '${CronResponse.prefix}.cleanup_unreferenced_photos';
