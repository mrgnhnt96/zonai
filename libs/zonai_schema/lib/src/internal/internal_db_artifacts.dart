...
import 'package:zonai_schema/src/internal/tables/oauth_identity_table.dart' as _schema_oauthIdentities;
import 'package:zonai_schema/src/internal/tables/photos_table.dart' as _schema_photos;
import 'package:zonai_schema/src/internal/tables/push_jobs_table.dart' as _schema_pushJobs;
...
abstract final class InternalDbArtifacts {
  ...
  static const tableNames = {'_abusers', '_auth_challenges', '_cron_jobs', '_jwt', '_log', '_oauth_identities', '_photos', '_push_jobs', '_rate_limit'};
}
