...
final class InvitesId implements z.Id {
  const InvitesId(this.value);

  static const _suffix = 'inv';

  factory InvitesId.generate() =>
      InvitesId('${DateTime.now().microsecondsSinceEpoch}_$_suffix');
