...
- **The published CLI acting as host** — still missed, but it now *says so*.
  ...
  what this doc and `docs/design/linking-a-bare-released-binary.md` both said until
  ...
  See `docs/design/dart-sdk-skew.md`. The reason the two were solved differently is
  ...
  **This has nothing to do with project linking**, which is how it was first
  written down here and in `docs/design/linking-a-bare-released-binary.md`.
  ...
  `docs/design/linking-a-bare-released-binary.md` on why.
