...
alternative to [`docs/external-idp.md`](https://docs.zonai.dev/authentication/external-idp) (trusting a token
...
Design history: [`docs/design/oauth-design.md`](oauth-design.md). Everything below
...
See [`docs/design/admin-invite-design.md`](admin-invite-design.md).
...
- [`docs/external-idp.md`](https://docs.zonai.dev/authentication/external-idp) — the alternative: trust JWTs an
  existing IdP already issues, instead of zonai running the OAuth flow.
- [`docs/design/oauth-design.md`](oauth-design.md) — the original design and build
...
- [`docs/design/admin-invite-design.md`](admin-invite-design.md) — how someone is
