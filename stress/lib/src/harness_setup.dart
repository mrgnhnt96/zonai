...
/// resolve the local monorepo packages (raindrop, zonai_schema, resqlite) the
/// same way the workspace does. The `revali` family is NOT overridden — it
/// resolves from pub.dev, so the harness needs no local revali checkout.
///
