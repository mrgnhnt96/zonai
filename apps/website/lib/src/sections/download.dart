...
const _glyphs = <String, String>{
  'apple': 'M15.8 12.6c0-2.2 1.8-3.2 1.9-3.3-1-1.5-2.6-1.7-3.2-1.7-1.4-.1-2.7.8-3.4.8s-1.8-.8-2.9-.8c-1.5 0-2.9.9-3.6 2.2'
  ...
  'linux': 'M12 2.8c-2 0-3.1 1.7-3.1 3.7 0 1.3.2 2 .1 2.8-.2 1.1-1.4 2.6-2 4.1-.5 1.4-.4 2.7-.2 3.4.2.7 0 1.3-.4 1.9'
  ...
  'windows': 'M3.6 6.1 10.4 5.2v6.3H3.6V6.1Zm0 11.8 6.8.9v-6.2H3.6v5.3Zm8.1 1L20.4 20V12.2h-8.7v6.7Zm0-14 8.7-1.2v7.7h-8.7V4.9Z',
      ...
      children: [
        ...
        div(classes: 'dl-foot', [
          span(classes: 'dl-foot-ver', [
            ...
            a(href: Links.release, target: .blank, attributes: const {'rel': 'noopener'}, [
