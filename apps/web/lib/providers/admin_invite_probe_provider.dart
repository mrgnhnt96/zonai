...
typedef AdminInviteAccept = Future<void> Function(String token, {String? password, Map<String, dynamic>? values});
...
final adminInviteAcceptProvider = Provider<AdminInviteAccept>((ref) {
  return (token, {password, values}) =>
      acceptAdminInvite(server: ref.read(revaliServerProvider), token: token, password: password, values: values);
});
